  ...
  <div>
    <div v-if="articledata.length > 0">
      ...
      >
        ...
        <el-table-column property="star" label="重要性" width="150" header-align="center" align="center">
          <template slot-scope="scope">
            <el-rate
        ...
        <el-table-column label="操作" header-align="center" align="center">
          <template slot-scope="scope">
            ...
            <el-button size="mini" type="danger" @click="handleDelete(scope)"
              >删除</el-button
            >
            <el-button size="mini" type="success" @click="handleCheck(scope)"
              >查看</el-button
            >
          </template>
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleCheck(scope) {
      ...
      // this.$router.push({name: "checked",query:{data: JSON.stringify(scope.row)}})
    },
