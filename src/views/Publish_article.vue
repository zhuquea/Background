<template>
  <div class="publish__article">
    <div class="article__first">
      <div class="article__see">
        <el-button type="danger" @click="checked">查看</el-button>
      </div>
      <div class="article__release">
        <el-button type="primary" @click="released">发布</el-button>
      </div>
      <div class="article__return" v-if="showhide === false">
        <el-button type="info" @click="returned">返回</el-button>
      </div>
    </div>
    <div v-if="showhide">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        region1: [{ required: true, message: "请选择类目", trigger: "change" }],
        region2: [{ required: true, message: "请选择来源", trigger: "change" }],
        region3: [
